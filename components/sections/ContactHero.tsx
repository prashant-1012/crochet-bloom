      ...
      <div className="mx-auto grid max-w-5xl items-center gap-10 px-4 py-12 sm:px-6 lg:grid-cols-2 lg:gap-16 lg:px-10 lg:py-16 xl:px-12">
        <Reveal>
          ...
          <p className="mt-4 text-lg text-warm-gray">
            Questions about a bouquet, a custom color combination, or a bulk
            gifting order — reach out and we&apos;ll get back to you over
            WhatsApp.
          </p>
        </Reveal>
        ...
        <Reveal delay={0.1}>
          <div className="relative mx-auto h-[280px] w-[280px] sm:h-[340px] sm:w-[340px]">
            ...
            <div className="relative h-full w-full overflow-hidden rounded-[2.5rem] shadow-lift">
              <Image
                src="/images/products/single-rose-bouquet.jpeg"
                alt="A hand holding out a wrapped hand-crocheted rose bouquet"
                fill
                priority
